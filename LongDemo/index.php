...
use Controller\managerStudent;

if ($_SERVER['REQUEST_METHOD']==="POST"){
    include_once "../class/student.php";
    include_once "../class/manageStudent.php";
    $name= $_POST["name"];
    $age= $_POST["age"];
    ...
    $manageStudent = new ManageStudent($pathfile);
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
            <input class="form-control mr-sm-2" type="text" na>
...
<form method="post">
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="exampleFormControlSelect1" name="group">
            ...
            <option value="C1019I2" >C1019I2</option>
            <option value="C1019I3">C1019I3</option>
            <option value="C1019I4">C1019I4</option>
            <option value="C1019I5">C1019I5</option>
        </select>
    </div>
